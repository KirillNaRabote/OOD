...
private:
	...
	CRectangleDecorator CreateRectangle(const std::string& rectangleInfo) const;
	CCircleDecorator CreateCircle(const std::string& circleInfo) const;
	CTriangleDecorator CreateTriangle(const std::string& triangleInfo) const;
